...
DATABASES = {
    ...
    'slave-1': {
        'ENGINE': 'django.db.backends.postgresql',
        "NAME": environments.NAME_SALVE_1,
        "USER": environments.USER_SALVE_1,
        "PASSWORD": environments.PASSWORD_SALVE_1,
        "HOST": environments.HOST_SALVE_1,
        "PORT": environments.PORT_SALVE_1
    },
